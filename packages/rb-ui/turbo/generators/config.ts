  ...
  plop.setGenerator("rb-component", {
    ...
    prompts: [
      ...
      },
      {
        ...
        name: "path",
        message:
          "컴포넌트를 생성할 src/components 다음 경로를 입력해주세요. (e.g., a/d/v) (없다면 Enter)",
      },
      {
        type: "input",
        name: "confirmation",
    ...
    actions: [
      ...
      },
      {
        ...
        template:
          '\nimport {{pascalCase name}} from "./{{#if path}}{{path}}/{{/if}}{{pascalCase name}}";',
      },
      {
        type: "append",
        path: "src/components/index.ts",
        ...
        template:
          '\nimport type { {{pascalCase name}}Props } from "./{{#if path}}{{path}}/{{/if}}{{pascalCase name}}";',
      },
      {
        type: "append",
        path: "src/components/index.ts",
