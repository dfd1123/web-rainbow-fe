      ...
      [
        'sass',
        {
          data: `
            ...
            @use "./src/styles/abstracts/_typography.scss" as *;
          `
        }
      ]
    ],
...
module.exports = [
    ...
    output: [
      {
        file: 'dist/provider/index.cjs.js',
        format: 'cjs',
        sourcemap: process.env.NODE_ENV !== 'production',
      },
      {
        file: 'dist/esm/provider/index.esm.mjs',
        format: 'esm',
        sourcemap: process.env.NODE_ENV !== 'production',
      },
    ],
  ...
  makeExportConfig({
    external:  [
      ...Object.keys(packageJson.dependencies).filter(dep => dep !== 'swiper'),
      /@babel\/runtime/,
      /fsevents/
    ],
    plugins,
